(function(){"use strict";try{if(typeof document<"u"){var e=document.createElement("style");e.appendChild(document.createTextNode(".ollama-chat-package[data-v-e2296da4]{display:flex;flex-direction:column;z-index:1000;border:1px solid rgba(0,0,0,.1)}.history-sidebar[data-v-e2296da4]{width:220px;height:100%;overflow-y:auto;border-right:1px solid rgba(0,0,0,.1);flex-shrink:0}.chat-area[data-v-e2296da4]{flex:1}.border-top[data-v-e2296da4]{border-top:1px solid rgba(0,0,0,.1)}.border-right[data-v-e2296da4]{border-right:1px solid rgba(0,0,0,.1)}.noselect[data-v-e2296da4]{-webkit-user-select:none;user-select:none}.resize-handle[data-v-e2296da4]{position:absolute;right:0;bottom:0;width:15px;height:15px;cursor:nwse-resize;background:linear-gradient(135deg,transparent 50%,#888 50%);z-index:1001}.markdown-body-wrapper[data-v-e2296da4]{contain:content;min-width:50px;line-height:1.5;font-size:.9rem;word-break:break-word}.markdown-body-wrapper.dark-mode[data-v-e2296da4]{color:#e0e0e0}.markdown-body-wrapper .code-wrapper[data-v-e2296da4]{position:relative;margin:10px 0;background:#1e1e1e;border-radius:6px;border:1px solid #444;overflow:hidden;backface-visibility:hidden}.markdown-body-wrapper .code-header[data-v-e2296da4]{background:#2d2d2d;padding:4px 10px;display:flex;justify-content:space-between;align-items:center}.markdown-body-wrapper .code-header span[data-v-e2296da4]{font-family:monospace;font-size:10px;color:#999;text-transform:uppercase}.markdown-body-wrapper .copy-btn[data-v-e2296da4]{background:#444;color:#fff;border:none;padding:2px 8px;border-radius:3px;font-size:9px;cursor:pointer}.markdown-body-wrapper .copy-btn[data-v-e2296da4]:hover{background:#027be3}.markdown-body-wrapper pre[data-v-e2296da4]{margin:0;padding:12px;overflow-x:auto;min-height:1em}.markdown-body-wrapper pre code[data-v-e2296da4]{color:#f8f8f2;white-space:pre-wrap}.slide-enter-active[data-v-e2296da4],.slide-leave-active[data-v-e2296da4]{transition:all .25s ease-out}.slide-enter-from[data-v-e2296da4],.slide-leave-to[data-v-e2296da4]{width:0;opacity:0;transform:translate(-10px)}")),document.head.appendChild(e)}}catch(a){console.error("vite-plugin-css-injected-by-js",a)}})();
import { computed as Ou, ref as O, reactive as re, onMounted as ce, nextTick as $u, resolveComponent as M, resolveDirective as oe, createElementBlock as xu, openBlock as j, normalizeStyle as ie, normalizeClass as ru, createVNode as v, createElementVNode as _u, withCtx as w, createBlock as cu, createCommentVNode as Fu, createTextVNode as mu, toDisplayString as a0, unref as ae, Transition as se, Fragment as s0, renderList as l0, withDirectives as le, withModifiers as fe, withKeys as de } from "vue";
import { useQuasar as he, copyToClipboard as be, QTooltip as pe, QItemLabel as xe, QItemSection as _e, QItem as me, QList as ke, QSpinnerDots as ge, QScrollArea as Ce, QChatMessage as De, QAvatar as ye, QIcon as Ee, QToolbarTitle as Ae, QToolbar as Fe, QInput as ve, QBtn as we, Ripple as Se } from "quasar";
const f0 = {};
function Te(u) {
  let e = f0[u];
  if (e)
...
function au(u, e) {
  typeof e != "string" && (e = au.defaultChars);
  const t = Te(e);
...
const Be = /^([a-z0-9.+-]+:)/i, ze = /:[0-9]*$/, Ie = /^(\/\/?(?!\/)[^\?\s]*)(\?[^\s]*)?$/, Me = ["<", ">", '"', "`", " ", "\r", `
`, "	"], Re = ["{", "}", "|", "\\", "^", "`"].concat(Me), Le = ["'"].concat(Re), h0 = ["%", "/", "?", ";", "#"].concat(Le), b0 = ["/", "?", "#"], Pe = 255, p0 = /^[+a-z0-9A-Z_-]{0,63}$/, Ne = /^([+a-z0-9A-Z_-]{0,63})(.*)$/, x0 = {
  javascript: !0,
  "javascript:": !0
}, _0 = {
  http: !0,
...
Su.prototype.parse = function(u, e) {
  ...
  let i = Be.exec(c);
  if (i && (i = i[0], t = i.toLowerCase(), this.protocol = i, c = c.substr(i.length)), (e || i || c.match(/^\/\/[^@\/]+@[^@\/]+/)) && (n = c.substr(0, 2) === "//", n && !(i && x0[i]) && (c = c.substr(2), this.slashes = !0)), !x0[i] && (n || i && !_0[i])) {
    let s = -1;
    for (let l = 0; l < b0.length; l++)
      r = c.indexOf(b0[l]), r !== -1 && (s === -1 || r < s) && (s = r);
    let f, d;
    s === -1 ? d = c.lastIndexOf("@") : d = c.lastIndexOf("@", s), d !== -1 && (f = c.slice(0, d), c = c.slice(d + 1), this.auth = f), s = -1;
    for (let l = 0; l < h0.length; l++)
      r = c.indexOf(h0[l]), r !== -1 && (s === -1 || r < s) && (s = r);
      ...
      for (let g = 0, D = l.length; g < D; g++) {
        ...
        if (C && !C.match(p0)) {
          ...
          for (let x = 0, _ = C.length; x < _; x++)
            C.charCodeAt(x) > 127 ? p += "x" : p += C[x];
          if (!p.match(p0)) {
            const x = l.slice(0, g), _ = l.slice(g + 1), k = C.match(Ne);
            k && (x.push(k[1]), _.unshift(k[2])), _.length && (c = _.join(".") + c), this.hostname = x.join(".");
            break;
          }
        }
      }
    }
    this.hostname.length > Pe && (this.hostname = ""), h && (this.hostname = this.hostname.substr(1, this.hostname.length - 2));
  }
  const o = c.indexOf("#");
  o !== -1 && (this.hash = c.substr(o), c = c.slice(0, o));
  const a = c.indexOf("?");
  return a !== -1 && (this.search = c.substr(a), c = c.slice(0, a)), c && (this.pathname = c), _0[t] && this.hostname && !this.pathname && (this.pathname = ""), this;
};
...
const Oe = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  format: Yu,
  parse: Ku
}, Symbol.toStringTag, { value: "Module" })), S0 = /[\0-\uD7FF\uE000-\uFFFF]|[\uD800-\uDBFF][\uDC00-\uDFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/, T0 = /[\0-\x1F\x7F-\x9F]/, $e = /[\xAD\u0600-\u0605\u061C\u06DD\u070F\u0890\u0891\u08E2\u180E\u200B-\u200F\u202A-\u202E\u2060-\u2064\u2066-\u206F\uFEFF\uFFF9-\uFFFB]|\uD804[\uDCBD\uDCCD]|\uD80D[\uDC30-\uDC3F]|\uD82F[\uDCA0-\uDCA3]|\uD834[\uDD73-\uDD7A]|\uDB40[\uDC01\uDC20-\uDC7F]/, u0 = /[!-#%-\*,-\/:;\?@\[-\]_\{\}\xA1\xA7\xAB\xB6\xB7\xBB\xBF\u037E\u0387\u055A-\u055F\u0589\u058A\u05BE\u05C0\u05C3\u05C6\u05F3\u05F4\u0609\u060A\u060C\u060D\u061B\u061D-\u061F\u066A-\u066D\u06D4\u0700-\u070D\u07F7-\u07F9\u0830-\u083E\u085E\u0964\u0965\u0970\u09FD\u0A76\u0AF0\u0C77\u0C84\u0DF4\u0E4F\u0E5A\u0E5B\u0F04-\u0F12\u0F14\u0F3A-\u0F3D\u0F85\u0FD0-\u0FD4\u0FD9\u0FDA\u104A-\u104F\u10FB\u1360-\u1368\u1400\u166E\u169B\u169C\u16EB-\u16ED\u1735\u1736\u17D4-\u17D6\u17D8-\u17DA\u1800-\u180A\u1944\u1945\u1A1E\u1A1F\u1AA0-\u1AA6\u1AA8-\u1AAD\u1B5A-\u1B60\u1B7D\u1B7E\u1BFC-\u1BFF\u1C3B-\u1C3F\u1C7E\u1C7F\u1CC0-\u1CC7\u1CD3\u2010-\u2027\u2030-\u2043\u2045-\u2051\u2053-\u205E\u207D\u207E\u208D\u208E\u2308-\u230B\u2329\u232A\u2768-\u2775\u27C5\u27C6\u27E6-\u27EF\u2983-\u2998\u29D8-\u29DB\u29FC\u29FD\u2CF9-\u2CFC\u2CFE\u2CFF\u2D70\u2E00-\u2E2E\u2E30-\u2E4F\u2E52-\u2E5D\u3001-\u3003\u3008-\u3011\u3014-\u301F\u3030\u303D\u30A0\u30FB\uA4FE\uA4FF\uA60D-\uA60F\uA673\uA67E\uA6F2-\uA6F7\uA874-\uA877\uA8CE\uA8CF\uA8F8-\uA8FA\uA8FC\uA92E\uA92F\uA95F\uA9C1-\uA9CD\uA9DE\uA9DF\uAA5C-\uAA5F\uAADE\uAADF\uAAF0\uAAF1\uABEB\uFD3E\uFD3F\uFE10-\uFE19\uFE30-\uFE52\uFE54-\uFE61\uFE63\uFE68\uFE6A\uFE6B\uFF01-\uFF03\uFF05-\uFF0A\uFF0C-\uFF0F\uFF1A\uFF1B\uFF1F\uFF20\uFF3B-\uFF3D\uFF3F\uFF5B\uFF5D\uFF5F-\uFF65]|\uD800[\uDD00-\uDD02\uDF9F\uDFD0]|\uD801\uDD6F|\uD802[\uDC57\uDD1F\uDD3F\uDE50-\uDE58\uDE7F\uDEF0-\uDEF6\uDF39-\uDF3F\uDF99-\uDF9C]|\uD803[\uDEAD\uDF55-\uDF59\uDF86-\uDF89]|\uD804[\uDC47-\uDC4D\uDCBB\uDCBC\uDCBE-\uDCC1\uDD40-\uDD43\uDD74\uDD75\uDDC5-\uDDC8\uDDCD\uDDDB\uDDDD-\uDDDF\uDE38-\uDE3D\uDEA9]|\uD805[\uDC4B-\uDC4F\uDC5A\uDC5B\uDC5D\uDCC6\uDDC1-\uDDD7\uDE41-\uDE43\uDE60-\uDE6C\uDEB9\uDF3C-\uDF3E]|\uD806[\uDC3B\uDD44-\uDD46\uDDE2\uDE3F-\uDE46\uDE9A-\uDE9C\uDE9E-\uDEA2\uDF00-\uDF09]|\uD807[\uDC41-\uDC45\uDC70\uDC71\uDEF7\uDEF8\uDF43-\uDF4F\uDFFF]|\uD809[\uDC70-\uDC74]|\uD80B[\uDFF1\uDFF2]|\uD81A[\uDE6E\uDE6F\uDEF5\uDF37-\uDF3B\uDF44]|\uD81B[\uDE97-\uDE9A\uDFE2]|\uD82F\uDC9F|\uD836[\uDE87-\uDE8B]|\uD83A[\uDD5E\uDD5F]/, q0 = /[\$\+<->\^`\|~\xA2-\xA6\xA8\xA9\xAC\xAE-\xB1\xB4\xB8\xD7\xF7\u02C2-\u02C5\u02D2-\u02DF\u02E5-\u02EB\u02ED\u02EF-\u02FF\u0375\u0384\u0385\u03F6\u0482\u058D-\u058F\u0606-\u0608\u060B\u060E\u060F\u06DE\u06E9\u06FD\u06FE\u07F6\u07FE\u07FF\u0888\u09F2\u09F3\u09FA\u09FB\u0AF1\u0B70\u0BF3-\u0BFA\u0C7F\u0D4F\u0D79\u0E3F\u0F01-\u0F03\u0F13\u0F15-\u0F17\u0F1A-\u0F1F\u0F34\u0F36\u0F38\u0FBE-\u0FC5\u0FC7-\u0FCC\u0FCE\u0FCF\u0FD5-\u0FD8\u109E\u109F\u1390-\u1399\u166D\u17DB\u1940\u19DE-\u19FF\u1B61-\u1B6A\u1B74-\u1B7C\u1FBD\u1FBF-\u1FC1\u1FCD-\u1FCF\u1FDD-\u1FDF\u1FED-\u1FEF\u1FFD\u1FFE\u2044\u2052\u207A-\u207C\u208A-\u208C\u20A0-\u20C0\u2100\u2101\u2103-\u2106\u2108\u2109\u2114\u2116-\u2118\u211E-\u2123\u2125\u2127\u2129\u212E\u213A\u213B\u2140-\u2144\u214A-\u214D\u214F\u218A\u218B\u2190-\u2307\u230C-\u2328\u232B-\u2426\u2440-\u244A\u249C-\u24E9\u2500-\u2767\u2794-\u27C4\u27C7-\u27E5\u27F0-\u2982\u2999-\u29D7\u29DC-\u29FB\u29FE-\u2B73\u2B76-\u2B95\u2B97-\u2BFF\u2CE5-\u2CEA\u2E50\u2E51\u2E80-\u2E99\u2E9B-\u2EF3\u2F00-\u2FD5\u2FF0-\u2FFF\u3004\u3012\u3013\u3020\u3036\u3037\u303E\u303F\u309B\u309C\u3190\u3191\u3196-\u319F\u31C0-\u31E3\u31EF\u3200-\u321E\u322A-\u3247\u3250\u3260-\u327F\u328A-\u32B0\u32C0-\u33FF\u4DC0-\u4DFF\uA490-\uA4C6\uA700-\uA716\uA720\uA721\uA789\uA78A\uA828-\uA82B\uA836-\uA839\uAA77-\uAA79\uAB5B\uAB6A\uAB6B\uFB29\uFBB2-\uFBC2\uFD40-\uFD4F\uFDCF\uFDFC-\uFDFF\uFE62\uFE64-\uFE66\uFE69\uFF04\uFF0B\uFF1C-\uFF1E\uFF3E\uFF40\uFF5C\uFF5E\uFFE0-\uFFE6\uFFE8-\uFFEE\uFFFC\uFFFD]|\uD800[\uDD37-\uDD3F\uDD79-\uDD89\uDD8C-\uDD8E\uDD90-\uDD9C\uDDA0\uDDD0-\uDDFC]|\uD802[\uDC77\uDC78\uDEC8]|\uD805\uDF3F|\uD807[\uDFD5-\uDFF1]|\uD81A[\uDF3C-\uDF3F\uDF45]|\uD82F\uDC9C|\uD833[\uDF50-\uDFC3]|\uD834[\uDC00-\uDCF5\uDD00-\uDD26\uDD29-\uDD64\uDD6A-\uDD6C\uDD83\uDD84\uDD8C-\uDDA9\uDDAE-\uDDEA\uDE00-\uDE41\uDE45\uDF00-\uDF56]|\uD835[\uDEC1\uDEDB\uDEFB\uDF15\uDF35\uDF4F\uDF6F\uDF89\uDFA9\uDFC3]|\uD836[\uDC00-\uDDFF\uDE37-\uDE3A\uDE6D-\uDE74\uDE76-\uDE83\uDE85\uDE86]|\uD838[\uDD4F\uDEFF]|\uD83B[\uDCAC\uDCB0\uDD2E\uDEF0\uDEF1]|\uD83C[\uDC00-\uDC2B\uDC30-\uDC93\uDCA0-\uDCAE\uDCB1-\uDCBF\uDCC1-\uDCCF\uDCD1-\uDCF5\uDD0D-\uDDAD\uDDE6-\uDE02\uDE10-\uDE3B\uDE40-\uDE48\uDE50\uDE51\uDE60-\uDE65\uDF00-\uDFFF]|\uD83D[\uDC00-\uDED7\uDEDC-\uDEEC\uDEF0-\uDEFC\uDF00-\uDF76\uDF7B-\uDFD9\uDFE0-\uDFEB\uDFF0]|\uD83E[\uDC00-\uDC0B\uDC10-\uDC47\uDC50-\uDC59\uDC60-\uDC87\uDC90-\uDCAD\uDCB0\uDCB1\uDD00-\uDE53\uDE60-\uDE6D\uDE70-\uDE7C\uDE80-\uDE88\uDE90-\uDEBD\uDEBF-\uDEC5\uDECE-\uDEDB\uDEE0-\uDEE8\uDEF0-\uDEF8\uDF00-\uDF92\uDF94-\uDFCA]/, B0 = /[ \xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000]/, je = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  Any: S0,
  Cc: T0,
  Cf: $e,
  ...
  S: q0,
  Z: B0
}, Symbol.toStringTag, { value: "Module" })), He = new Uint16Array(
  // prettier-ignore
...
const Ze = /* @__PURE__ */ new Map([
  ...
  (ju = String.fromCodePoint) !== null && ju !== void 0 ? ju : function(u) {
    let e = "";
...
function Ge(u) {
  var e;
  return u >= 55296 && u <= 57343 || u > 1114111 ? 65533 : (e = Ze.get(u)) !== null && e !== void 0 ? e : u;
}
var z;
(function(u) {
...
function Je(u) {
  return u >= z.UPPER_A && u <= z.UPPER_Z || u >= z.LOWER_A && u <= z.LOWER_Z || Wu(u);
}
function Xe(u) {
...
class Ye {
  constructor(e, t, r) {
    this.decodeTree = e, this.emitCodePoint = t, this.errors = r, this.state = B.EntityStart, this.consumed = 1, this.result = 0, this.treeIndex = 0, this.excess = 1, this.decodeMode = K.Strict;
  }
  ...
  write(e, t) {
    switch (this.state) {
      case B.EntityStart:
        return e.charCodeAt(t) === z.NUM ? (this.state = B.NumericStart, this.consumed += 1, this.stateNumericStart(e, t + 1)) : (this.state = B.NamedEntity, this.stateNamedEntity(e, t));
      case B.NumericStart:
  ...
  stateNumericStart(e, t) {
    return t >= e.length ? -1 : (e.charCodeAt(t) | Qe) === z.LOWER_X ? (this.state = B.NumericHex, this.consumed += 1, this.stateNumericHex(e, t + 1)) : (this.state = B.NumericDecimal, this.stateNumericDecimal(e, t));
  }
  ...
  stateNamedEntity(e, t) {
    ...
    let n = r[this.treeIndex], c = (n & uu.VALUE_LENGTH) >> 14;
    for (; t < e.length; t++, this.excess++) {
      const i = e.charCodeAt(t);
      if (this.treeIndex = Ke(r, n, this.treeIndex + Math.max(1, c), i), this.treeIndex < 0)
        ...
        Xe(i)) ? 0 : this.emitNotTerminatedNamedEntity();
      if (n = r[this.treeIndex], c = (n & uu.VALUE_LENGTH) >> 14, c !== 0) {
        if (i === z.SEMI)
          return this.emitNamedEntityData(this.treeIndex, c, this.consumed + this.excess);
        this.decodeMode !== K.Strict && (this.result = this.treeIndex, this.consumed += this.excess, this.excess = 0);
      }
    }
    return -1;
  }
  ...
  emitNotTerminatedNamedEntity() {
    var e;
    const { result: t, decodeTree: r } = this, n = (r[t] & uu.VALUE_LENGTH) >> 14;
  ...
  emitNamedEntityData(e, t, r) {
    ...
    return this.emitCodePoint(t === 1 ? n[e] & ~uu.VALUE_LENGTH : n[e + 1], r), t === 3 && this.emitCodePoint(n[e + 2], r), r;
  }
  /**
...
function Ke(u, e, t, r) {
  const n = (e & uu.BRANCH_LENGTH) >> 7, c = e & uu.JUMP_TABLE;
  if (n === 0)
    return c !== 0 && r === c ? t : -1;
  if (c) {
    const a = r - c;
...
const R0 = /\\([!"#$%&'()*+,\-./:;<=>?@[\\\]^_`{|}~])/g, rt = /&([a-z#][a-z0-9]{1,31});/gi, ct = new RegExp(R0.source + "|" + rt.source, "gi"), ot = /^#((?:x[a-f0-9]{1,8}|[0-9]{1,8}))$/i;
function it(u, e) {
  if (e.charCodeAt(0) === 35 && ot.test(e)) {
...
function at(u) {
  return u.indexOf("\\") < 0 ? u : u.replace(R0, "$1");
}
function su(u) {
  return u.indexOf("\\") < 0 && u.indexOf("&") < 0 ? u : u.replace(ct, function(e, t, r) {
    return t || it(e, r);
  });
}
const st = /[&<>"]/, lt = /[&<>"]/g, ft = {
...
function eu(u) {
  return st.test(u) ? u.replace(lt, dt) : u;
}
const ht = /[.?*+^$[\]\\(){}|-]/g;
function bt(u) {
  return u.replace(ht, "\\$&");
...
const pt = { mdurl: Oe, ucmicro: je }, xt = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  arrayReplaceAt: M0,
  assign: Bu,
  escapeHtml: eu,
...
function mt(u, e, t) {
  ...
  if (u.charCodeAt(n) === 60) {
    for (n++; n < t; ) {
      if (r = u.charCodeAt(n), r === 10 || r === 60)
        return c;
      if (r === 62)
        return c.pos = n + 1, c.str = su(u.slice(e + 1, n)), c.ok = !0, c;
      if (r === 92 && n + 1 < t) {
        n += 2;
        continue;
      }
  ...
  return e === n || i !== 0 || (c.str = su(u.slice(e, n)), c.pos = n, c.ok = !0), c;
}
function kt(u, e, t, r) {
  let n, c = e;
  const i = {
  ...
  for (; c < t; ) {
    if (n = u.charCodeAt(c), n === i.marker)
      return i.pos = c + 1, i.str += su(u.slice(e, c)), i.ok = !0, i;
    if (n === 40 && i.marker === 41)
      return i;
    n === 92 && c + 1 < t && c++, c++;
  }
  return i.can_continue = !0, i.str += su(u.slice(e, c)), i;
}
const gt = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  parseLinkDestination: mt,
  parseLinkLabel: _t,
  parseLinkTitle: kt
}, Symbol.toStringTag, { value: "Module" })), G = {};
G.code_inline = function(u, e, t, r, n) {
  const c = u[e];
  return "<code" + n.renderAttrs(c) + ">" + eu(c.content) + "</code>";
};
G.code_block = function(u, e, t, r, n) {
  const c = u[e];
  return "<pre" + n.renderAttrs(c) + "><code>" + eu(u[e].content) + `</code></pre>
`;
};
G.fence = function(u, e, t, r, n) {
  const c = u[e], i = c.info ? su(c.info).trim() : "";
  let o = "", a = "";
  if (i) {
    const f = i.split(/(\s+)/g);
  ...
  let s;
  if (t.highlight ? s = t.highlight(c.content, o, a) || eu(c.content) : s = eu(c.content), s.indexOf("<pre") === 0)
    return s + `
`;
  if (i) {
...
lu.prototype.renderAttrs = function(e) {
  ...
  for (n = "", t = 0, r = e.attrs.length; t < r; t++)
    n += " " + eu(e.attrs[t][0]) + '="' + eu(e.attrs[t][1]) + '"';
  return n;
};
lu.prototype.renderToken = function(e, t, r) {
  const n = e[t];
  let c = "";
  if (n.hidden)
    return "";
...
lu.prototype.renderInline = function(u, e, t) {
  let r = "";
  const n = this.rules;
  for (let c = 0, i = u.length; c < i; c++) {
    const o = u[c].type;
...
lu.prototype.renderInlineAsText = function(u, e, t) {
  let r = "";
...
lu.prototype.render = function(u, e, t) {
  let r = "";
  const n = this.rules;
  for (let c = 0, i = u.length; c < i; c++) {
    const o = u[c].type;
...
R.prototype.before = function(u, e, t, r) {
...
R.prototype.after = function(u, e, t, r) {
  const n = this.__find__(u), c = r || {};
  if (n === -1)
    throw new Error("Parser rule not found: " + u);
...
L0.prototype.Token = H;
const Ct = /\r\n?|\n/g, Dt = /\0/g;
function yt(u) {
  let e;
  e = u.src.replace(Ct, `
`), e = e.replace(Dt, "�"), u.src = e;
}
function Et(u) {
  let e;
  ...
  if (u.md.options.linkify)
    for (let t = 0, r = e.length; t < r; t++) {
      ...
      for (let i = n.length - 1; i >= 0; i--) {
        ...
        if (o.type === "html_inline" && (Ft(o.content) && c > 0 && c--, vt(o.content) && c++), !(c > 0) && o.type === "text" && u.md.linkify.test(o.content)) {
          const a = o.content;
          ...
          for (let h = 0; h < s.length; h++) {
            ...
            if (C > b) {
              ...
              k.content = a.slice(b, C), k.level = d, f.push(k);
            }
            const p = new u.Token("link_open", "a", 1);
            p.attrs = [["href", g]], p.level = d++, p.markup = "linkify", p.info = "auto", f.push(p);
            const x = new u.Token("text", "", 0);
            x.content = D, x.level = d, f.push(x);
          ...
          e[t].children = n = M0(n, i, f);
        }
      }
    }
}
const P0 = /\+-|\.\.|\?\?\?\?|!!!!|,,|--/, St = /\((c|tm|r)\)/i, Tt = /\((c|tm|r)\)/ig, qt = {
  c: "©",
  r: "®",
  tm: "™"
};
...
function zt(u) {
  ...
  for (let t = u.length - 1; t >= 0; t--) {
    const r = u[t];
    r.type === "text" && !e && (r.content = r.content.replace(Tt, Bt)), r.type === "link_open" && r.info === "auto" && e--, r.type === "link_close" && r.info === "auto" && e++;
  }
}
function It(u) {
  let e = 0;
  for (let t = u.length - 1; t >= 0; t--) {
    const r = u[t];
    r.type === "text" && !e && P0.test(r.content) && (r.content = r.content.replace(/\+-/g, "±").replace(/\.{2,}/g, "…").replace(/([?!])…/g, "$1..").replace(/([?!]){4,}/g, "$1$1$1").replace(/,{2,}/g, ",").replace(/(^|[^-])---(?=[^-]|$)/mg, "$1—").replace(/(^|\s)--(?=\s|$)/mg, "$1–").replace(/(^|[^-\s])--(?=[^-\s]|$)/mg, "$1–")), r.type === "link_open" && r.info === "auto" && e--, r.type === "link_close" && r.info === "auto" && e++;
  }
}
function Mt(u) {
  let e;
  if (u.md.options.typographer)
    for (e = u.tokens.length - 1; e >= 0; e--)
      u.tokens[e].type === "inline" && (St.test(u.tokens[e].content) && zt(u.tokens[e].children), P0.test(u.tokens[e].content) && It(u.tokens[e].children));
}
const Rt = /['"]/, m0 = /['"]/g, k0 = "’";
function vu(u, e, t) {
  ...
  for (let n = 0; n < u.length; n++) {
    ...
    u:
      for (; a < s; ) {
        ...
        const D = Cu(l) || gu(String.fromCharCode(l)), C = Cu(g) || gu(String.fromCharCode(g)), p = ku(l), x = ku(g);
        if (x ? d = !1 : C && (p || D || (d = !1)), p ? b = !1 : D && (x || C || (b = !1)), g === 34 && f[0] === '"' && l >= 48 && l <= 57 && (b = d = !1), d && b && (d = D, b = C), !d && !b) {
          h && (c.content = vu(c.content, f.index, k0));
          continue;
        }
        if (b)
          for (t = r.length - 1; t >= 0; t--) {
            ...
            if (r[t].level < i)
              break;
            if (_.single === h && r[t].level === i) {
              _ = r[t];
              let k, E;
              h ? (k = e.md.options.quotes[2], E = e.md.options.quotes[3]) : (k = e.md.options.quotes[0], E = e.md.options.quotes[1]), c.content = vu(c.content, f.index, E), u[_.token].content = vu(
                u[_.token].content,
                _.pos,
                k
              ), a += E.length - 1, _.token === n && (a += k.length - 1), o = c.content, s = o.length, r.length = t;
              continue u;
            }
          }
        d ? r.push({
          ...
          single: h,
          level: i
        }) : b && h && (c.content = vu(c.content, f.index, k0));
      }
  }
}
function Pt(u) {
  if (u.md.options.typographer)
    for (let e = u.tokens.length - 1; e >= 0; e--)
      u.tokens[e].type !== "inline" || !Rt.test(u.tokens[e].content) || Lt(u.tokens[e].children, u);
}
function Nt(u) {
  let e, t;
...
n0.prototype.process = function(u) {
  const e = this.ruler.getRules("");
  for (let t = 0, r = e.length; t < r; t++)
    e[t](u);
};
n0.prototype.State = L0;
function Q(u, e, t, r) {
  ...
  const n = this.src;
  for (let c = 0, i = 0, o = 0, a = 0, s = n.length, f = !1; i < s; i++) {
...
Q.prototype.getLines = function(e, t, r, n) {
  ...
  for (let i = 0, o = e; o < t; o++, i++) {
    ...
    let f = s, d;
    for (o + 1 < t || n ? d = this.eMarks[o] + 1 : d = this.eMarks[o]; f < d && a < r; ) {
    ...
    a > r ? c[i] = new Array(a - r + 1).join(" ") + this.src.slice(f, d) : c[i] = this.src.slice(f, d);
  }
  return c.join("");
};
Q.prototype.Token = H;
...
function $t(u, e, t, r) {
  ...
  if (o !== 124 && o !== 45 && o !== 58 && !A(o) || i === 45 && A(o))
    return !1;
  for (; c < u.eMarks[n]; ) {
    const _ = u.src.charCodeAt(c);
    if (_ !== 124 && _ !== 45 && _ !== 58 && !A(_))
      return !1;
    c++;
  }
  let a = Uu(u, e + 1), s = a.split("|");
  const f = [];
  ...
  if (a = Uu(u, e).trim(), a.indexOf("|") === -1 || u.sCount[e] - u.blkIndent >= 4)
    return !1;
  s = g0(a), s.length && s[0] === "" && s.shift(), s.length && s[s.length - 1] === "" && s.pop();
  const d = s.length;
  if (d === 0 || d !== f.length)
    return !1;
  if (r)
  ...
  for (let _ = 0; _ < s.length; _++) {
    ...
    E.content = s[_].trim(), E.children = [], u.push("th_close", "th", -1);
  }
  ...
  for (n = e + 2; n < t && !(u.sCount[n] < u.blkIndent); n++) {
    ...
    if (_ || (a = Uu(u, n).trim(), !a) || u.sCount[n] - u.blkIndent >= 4 || (s = g0(a), s.length && s[0] === "" && s.shift(), s.length && s[s.length - 1] === "" && s.pop(), x += d - s.length, x > Ot))
      break;
    if (n === e + 2) {
    ...
    for (let E = 0; E < d; E++) {
      ...
      f[E] && (S.attrs = [["style", "text-align:" + f[E]]]);
      const I = u.push("inline", "", 0);
      I.content = s[E] ? s[E].trim() : "", I.children = [], u.push("td_close", "td", -1);
    }
...
function Ht(u, e, t, r) {
  ...
  if (a < 3)
    return !1;
  const s = u.src.slice(o, n), f = u.src.slice(n, c);
...
function Ut(u, e, t, r) {
  ...
  for (l = e; l < t; l++) {
    ...
    if (n = u.bMarks[l] + u.tShift[l], c = u.eMarks[l], n >= c)
      break;
    if (u.src.charCodeAt(n++) === 62 && !x) {
      let k = u.sCount[l] + 1, E, S;
      u.src.charCodeAt(n) === 32 ? (n++, k++, S = !1, E = !0) : u.src.charCodeAt(n) === 9 ? (E = !0, (u.bsCount[l] + k) % 4 === 3 ? (n++, k++, S = !1) : S = !0) : E = !1;
      let I = k;
      for (o.push(u.bMarks[l]), u.bMarks[l] = n; n < c; ) {
        const P = u.src.charCodeAt(n);
        if (A(P))
          P === 9 ? I += 4 - (I + u.bsCount[l] + (S ? 1 : 0)) % 4 : I++;
        else
          break;
        n++;
      }
      h = n >= c, a.push(u.bsCount[l]), u.bsCount[l] = u.sCount[l] + 1 + (E ? 1 : 0), s.push(u.sCount[l]), u.sCount[l] = I - k, f.push(u.tShift[l]), u.tShift[l] = n - u.bMarks[l];
      continue;
    }
    if (h)
      break;
  ...
  D.markup = ">";
  const C = [e, 0];
  D.map = C, u.md.block.tokenize(u, e, l);
  const p = u.push("blockquote_close", "blockquote", -1);
  p.markup = ">", u.lineMax = i, u.parentType = b, C[1] = u.line;
  for (let x = 0; x < f.length; x++)
    u.bMarks[x + e] = o[x], u.tShift[x + e] = f[x], u.sCount[x + e] = s[x], u.bsCount[x + e] = a[x];
...
function D0(u, e) {
  ...
  return n < r && (c = u.src.charCodeAt(n), !A(c)) ? -1 : n;
}
function Vt(u, e) {
  const t = u.level + 2;
...
function Gt(u, e, t, r) {
  ...
  for (u.parentType = "list"; a < t; ) {
    ...
    const E = c;
    let S;
    E >= n ? S = 1 : S = k - _, S > 4 && (S = 1);
    const I = _ + S;
    o = u.push("list_item_open", "li", 1), o.markup = String.fromCharCode(l);
    const P = [a, 0];
    o.map = P, d && (o.info = u.src.slice(i, h - 1));
    const tu = u.tight, fu = u.tShift[a], Ru = u.sCount[a], du = u.listIndent;
    if (u.listIndent = u.blkIndent, u.blkIndent = I, u.tight = !0, u.tShift[a] = E - u.bMarks[a], u.sCount[a] = k, E >= n && u.isEmpty(a + 1) ? u.line = Math.min(u.line + 2, t) : u.md.block.tokenize(u, a, t, !0), (!u.tight || C) && (s = !1), C = u.line - a > 1 && u.isEmpty(u.line - 1), u.blkIndent = u.listIndent, u.listIndent = du, u.tShift[a] = fu, u.sCount[a] = Ru, u.tight = tu, o = u.push("list_item_close", "li", -1), o.markup = String.fromCharCode(l), a = u.line, P[1] = a, a >= t || u.sCount[a] < u.blkIndent || u.sCount[a] - u.blkIndent >= 4)
      break;
    let hu = !1;
    for (let X = 0, nu = p.length; X < nu; X++)
      if (p[X](u, a, t, !0)) {
        hu = !0;
        break;
      }
    ...
    } else if (h = C0(u, a), h < 0)
      break;
    if (l !== u.src.charCodeAt(h - 1))
      break;
  }
  return d ? o = u.push("ordered_list_close", "ol", -1) : o = u.push("bullet_list_close", "ul", -1), o.markup = String.fromCharCode(l), D[1] = a, u.line = a, u.parentType = x, s && Vt(u, g), !0;
}
function Qt(u, e, t, r) {
  ...
  function o(p) {
    ...
    if (u.sCount[p] - u.blkIndent > 3 && (_ = !0), u.sCount[p] < 0 && (_ = !0), !_) {
      const S = u.md.block.ruler.getRules("reference"), I = u.parentType;
      u.parentType = "reference";
      let P = !1;
      for (let tu = 0, fu = S.length; tu < fu; tu++)
        if (S[tu](u, p, x, !0)) {
          P = !0;
          break;
        }
  ...
  let D;
  for (n < c && l !== n && g.ok ? (D = g.str, n = g.pos) : (D = "", n = b, i = h); n < c; ) {
    const p = a.charCodeAt(n);
    if (!A(p))
      break;
    n++;
  }
  if (n < c && a.charCodeAt(n) !== 10 && D)
    for (D = "", n = b, i = h; n < c; ) {
      const p = a.charCodeAt(n);
      if (!A(p))
        break;
  ...
  if (n < c && a.charCodeAt(n) !== 10)
    return !1;
  const C = zu(a.slice(1, s));
  return C ? (r || (typeof u.env.references > "u" && (u.env.references = {}), typeof u.env.references[C] > "u" && (u.env.references[C] = { title: D, href: d }), u.line = i), !0) : !1;
}
const Wt = [
  "address",
  "article",
  ...
  "track",
  "ul"
], Jt = "[a-zA-Z_:][a-zA-Z0-9:._-]*", Xt = "[^\"'=<>`\\x00-\\x20]+", Yt = "'[^']*'", Kt = '"[^"]*"', un = "(?:" + Xt + "|" + Yt + "|" + Kt + ")", en = "(?:\\s+" + Jt + "(?:\\s*=\\s*" + un + ")?)", N0 = "<[A-Za-z][A-Za-z0-9\\-]*" + en + "*\\s*\\/?>", O0 = "<\\/[A-Za-z][A-Za-z0-9\\-]*\\s*>", tn = "<!---?>|<!--(?:[^-]|-[^-]|--[^>])*-->", nn = "<[?][\\s\\S]*?[?]>", rn = "<![A-Za-z][^>]*>", cn = "<!\\[CDATA\\[[\\s\\S]*?\\]\\]>", on = new RegExp("^(?:" + N0 + "|" + O0 + "|" + tn + "|" + nn + "|" + rn + "|" + cn + ")"), an = new RegExp("^(?:" + N0 + "|" + O0 + ")"), ou = [
  [/^<(script|pre|style|textarea)(?=(\s|>|$))/i, /<\/(script|pre|style|textarea)>/i, !0],
  [/^<!--/, /-->/, !0],
  [/^<\?/, /\?>/, !0],
  [/^<![A-Z]/, />/, !0],
  [/^<!\[CDATA\[/, /\]\]>/, !0],
  [new RegExp("^</?(" + Wt.join("|") + ")(?=(\\s|/?>|$))", "i"), /^$/, !0],
  [new RegExp(an.source + "\\s*$"), /^$/, !1]
];
function sn(u, e, t, r) {
  let n = u.bMarks[e] + u.tShift[e], c = u.eMarks[e];
  ...
  for (; o < ou.length && !ou[o][0].test(i); o++)
    ;
  if (o === ou.length)
    return !1;
  if (r)
  ...
  if (!ou[o][1].test(i)) {
    for (; a < t && !(u.sCount[a] < u.blkIndent); a++)
      if (n = u.bMarks[a] + u.tShift[a], c = u.eMarks[a], i = u.src.slice(n, c), ou[o][1].test(i)) {
        i.length !== 0 && a++;
        break;
      }
  }
...
function ln(u, e, t, r) {
  ...
  a > n && A(u.src.charCodeAt(a - 1)) && (c = a), u.line = e + 1;
...
const wu = [
  ...
  ["code", jt],
  ["fence", Ht, ["paragraph", "reference", "blockquote", "list"]],
  ["blockquote", Ut, ["paragraph", "reference", "blockquote", "list"]],
  ["hr", Zt, ["paragraph", "reference", "blockquote", "list"]],
  ["list", Gt, ["paragraph", "reference", "blockquote"]],
  ["reference", Qt],
  ["html_block", sn, ["paragraph", "reference", "blockquote"]],
  ["heading", ln, ["paragraph", "reference", "blockquote"]],
  ["lheading", fn],
  ["paragraph", dn]
];
function Iu() {
  ...
  for (let u = 0; u < wu.length; u++)
    this.ruler.push(wu[u][0], wu[u][1], { alt: (wu[u][2] || []).slice() });
}
Iu.prototype.tokenize = function(u, e, t) {
...
Eu.prototype.scanDelims = function(u, e) {
  ...
  for (; c < t && this.src.charCodeAt(c) === r; )
    c++;
  const i = c - u, o = c < t ? this.src.charCodeAt(c) : 32, a = Cu(n) || gu(String.fromCharCode(n)), s = Cu(o) || gu(String.fromCharCode(o)), f = ku(n), d = ku(o), b = !d && (!s || f || a), h = !f && (!a || d || s);
  return { can_open: b && (e || !h || a), can_close: h && (e || !b || s), length: i };
};
Eu.prototype.Token = H;
function hn(u) {
  switch (u) {
    case 10:
    case 33:
...
function _n(u, e) {
  ...
  for (t++; t < n && A(u.src.charCodeAt(t)); )
    t++;
  return u.pos = t, !0;
}
const r0 = [];
...
function mn(u, e) {
  ...
  if (n === 10) {
    for (e || u.push("hardbreak", "br", 0), t++; t < r && (n = u.src.charCodeAt(t), !!A(n)); )
      t++;
    return u.pos = t, !0;
  }
  let c = u.src[t];
  ...
  if (!e) {
    ...
    n < 256 && r0[n] !== 0 ? o.content = c : o.content = i, o.markup = i, o.info = "escape";
  }
  return u.pos = t + 1, !0;
}
function kn(u, e) {
...
function Cn(u) {
  ...
  y0(u, u.delimiters);
  for (let r = 0; r < t; r++)
    e[r] && e[r].delimiters && y0(u, e[r].delimiters);
}
const $0 = {
  tokenize: gn,
  postProcess: Cn
...
function yn(u) {
  ...
  E0(u, u.delimiters);
  for (let r = 0; r < t; r++)
    e[r] && e[r].delimiters && E0(u, e[r].delimiters);
}
const j0 = {
  tokenize: Dn,
  postProcess: yn
...
function En(u, e) {
  ...
  if (l < d && u.src.charCodeAt(l) === 40) {
    for (s = !1, l++; l < d && (t = u.src.charCodeAt(l), !(!A(t) && t !== 10)); l++)
      ;
    if (l >= d)
      return !1;
    if (a = l, n = u.md.helpers.parseLinkDestination(u.src, l, u.posMax), n.ok) {
      for (i = u.md.normalizeLink(n.str), u.md.validateLink(i) ? l = n.pos : i = "", a = l; l < d && (t = u.src.charCodeAt(l), !(!A(t) && t !== 10)); l++)
        ;
      if (n = u.md.helpers.parseLinkTitle(u.src, l, u.posMax), l < d && a !== l && n.ok)
        for (o = n.str, l = n.pos; l < d && (t = u.src.charCodeAt(l), !(!A(t) && t !== 10)); l++)
          ;
    }
  ...
  if (s) {
    if (typeof u.env.references > "u")
      return !1;
    if (l < d && u.src.charCodeAt(l) === 91 ? (a = l + 1, l = u.md.helpers.parseLinkLabel(u, l), l >= 0 ? r = u.src.slice(a, l++) : l = h + 1) : l = h + 1, r || (r = u.src.slice(b, h)), c = u.env.references[zu(r)], !c)
      return u.pos = f, !1;
    i = c.href, o = c.title;
  }
  if (!e) {
    u.pos = b, u.posMax = h;
    const g = u.push("link_open", "a", 1), D = [["href", i]];
    g.attrs = D, o && D.push(["title", o]), u.linkLevel++, u.md.inline.tokenize(u), u.linkLevel--, u.push("link_close", "a", -1);
  }
  return u.pos = l, u.posMax = d, !0;
}
function An(u, e) {
  let t, r, n, c, i, o, a, s, f = "";
  ...
  if (c = l + 1, c < b && u.src.charCodeAt(c) === 40) {
    for (c++; c < b && (t = u.src.charCodeAt(c), !(!A(t) && t !== 10)); c++)
      ;
    if (c >= b)
      return !1;
    for (s = c, o = u.md.helpers.parseLinkDestination(u.src, c, u.posMax), o.ok && (f = u.md.normalizeLink(o.str), u.md.validateLink(f) ? c = o.pos : f = ""), s = c; c < b && (t = u.src.charCodeAt(c), !(!A(t) && t !== 10)); c++)
      ;
    if (o = u.md.helpers.parseLinkTitle(u.src, c, u.posMax), c < b && s !== c && o.ok)
      for (a = o.str, c = o.pos; c < b && (t = u.src.charCodeAt(c), !(!A(t) && t !== 10)); c++)
        ;
    else
      a = "";
    ...
    if (typeof u.env.references > "u")
      return !1;
    if (c < b && u.src.charCodeAt(c) === 91 ? (s = c + 1, c = u.md.helpers.parseLinkLabel(u, c), c >= 0 ? n = u.src.slice(s, c++) : c = l + 1) : c = l + 1, n || (n = u.src.slice(h, l)), i = u.env.references[zu(n)], !i)
      return u.pos = d, !1;
    f = i.href, a = i.title;
  }
  if (!e) {
    ...
    const D = u.push("image", "img", 0), C = [["src", f], ["alt", ""]];
    D.attrs = C, D.children = g, D.content = r, a && C.push(["title", a]);
  }
  return u.pos = c, u.posMax = b, !0;
}
const Fn = /^([a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)*)$/, vn = /^([a-zA-Z][a-zA-Z0-9+.-]{1,31}):([^<>\x00-\x20]*)$/;
function wn(u, e) {
  let t = u.pos;
...
function Bn(u, e) {
  ...
  if (n !== 33 && n !== 63 && n !== 47 && !qn(n))
    return !1;
  const c = u.src.slice(r).match(on);
  if (!c)
    return !1;
  if (!e) {
    const i = u.push("html_inline", "", 0);
    i.content = c[0], Sn(i.content) && u.linkLevel++, Tn(i.content) && u.linkLevel--;
  }
  return u.pos += c[0].length, !0;
}
const zn = /^&#((?:x[a-f0-9]{1,6}|[0-9]{1,7}));/i, In = /^&([a-z][a-z0-9]{1,31});/i;
function Mn(u, e) {
  const t = u.pos, r = u.posMax;
  if (u.src.charCodeAt(t) !== 38 || t + 1 >= r) return !1;
  if (u.src.charCodeAt(t + 1) === 35) {
    const c = u.src.slice(t).match(zn);
    if (c) {
      if (!e) {
        const i = c[1][0].toLowerCase() === "x" ? parseInt(c[1].slice(1), 16) : parseInt(c[1], 10), o = u.push("text_special", "", 0);
        o.content = t0(i) ? Tu(i) : Tu(65533), o.markup = c[0], o.info = "entity";
      }
      return u.pos += c[0].length, !0;
    }
  } else {
    const c = u.src.slice(t).match(In);
    if (c) {
      const i = I0(c[0]);
      if (i !== c[0]) {
        if (!e) {
...
function A0(u) {
  ...
  for (let i = 0; i < t; i++) {
    const o = u[i];
    if (c.push(0), (u[r].marker !== o.marker || n !== o.token - 1) && (r = i), n = o.token, o.length = o.length || 0, !o.close) continue;
    ...
    for (; s > a; s -= c[s] + 1) {
      ...
      if (d.marker === o.marker && d.open && d.end < 0) {
        ...
        if ((d.close || o.open) && (d.length + o.length) % 3 === 0 && (d.length % 3 !== 0 || o.length % 3 !== 0) && (b = !0), !b) {
          ...
          c[i] = i - s + h, c[s] = h, o.open = !1, d.end = i, d.close = !1, f = -1, n = -2;
          break;
        }
      }
    }
...
function Rn(u) {
  ...
  A0(u.delimiters);
  for (let r = 0; r < t; r++)
    e[r] && e[r].delimiters && A0(e[r].delimiters);
}
function Ln(u) {
  let e, t, r = 0;
...
Au.prototype.parse = function(u, e, t, r) {
  const n = new this.State(u, e, t, r);
  this.tokenize(n);
...
function Pn(u) {
  const e = {};
  u = u || {}, e.src_Any = S0.source, e.src_Cc = T0.source, e.src_Z = B0.source, e.src_P = u0.source, e.src_ZPCc = [e.src_Z, e.src_P, e.src_Cc].join("|"), e.src_ZCc = [e.src_Z, e.src_Cc].join("|");
  const t = "[><｜]";
...
function qu(u) {
  const e = u.re = Pn(u.__opts__), t = u.__tlds__.slice();
  u.onCompile(), u.__tlds_replaced__ || t.push(Zn), t.push(e.src_xn), e.src_tlds = t.join("|");
  function r(o) {
  ...
  Object.keys(u.__schemas__).forEach(function(o) {
    ...
    if (u.__compiled__[o] = s, On(a)) {
      $n(a.validate) ? s.validate = Qn(a.validate) : F0(a.validate) ? s.validate = a.validate : c(o, a), F0(a.normalize) ? s.normalize = a.normalize : a.normalize ? c(o, a) : s.normalize = v0();
      return;
    }
    if (Nn(a)) {
      n.push(o);
  ...
  }), u.__compiled__[""] = { validate: null, normalize: v0() };
...
function L(u, e) {
  if (!(this instanceof L))
    return new L(u, e);
  e || Hn(u) && (e = u, u = {}), this.__opts__ = Ju({}, H0, e), this.__index__ = -1, this.__last_index__ = -1, this.__schema__ = "", this.__text_cache__ = "", this.__schemas__ = Ju({}, Un, u), this.__compiled__ = {}, this.__tlds__ = Vn, this.__tlds_replaced__ = !1, this.re = {}, qu(this);
}
L.prototype.add = function(e, t) {
  return this.__schemas__[e] = t, qu(this), this;
};
L.prototype.set = function(e) {
  return this.__opts__ = Ju(this.__opts__, e), this;
};
...
L.prototype.testSchemaAt = function(e, t, r) {
  return this.__compiled__[t.toLowerCase()] ? this.__compiled__[t.toLowerCase()].validate(e, r, this) : 0;
};
L.prototype.match = function(e) {
  const t = [];
  let r = 0;
  this.__index__ >= 0 && this.__text_cache__ === e && (t.push(Xu(this, r)), r = this.__last_index__);
  let n = r ? e.slice(r) : e;
  for (; this.test(n); )
    t.push(Xu(this, r)), n = n.slice(this.__last_index__), r += this.__last_index__;
  return t.length ? t : null;
};
L.prototype.matchAtStart = function(e) {
  if (this.__text_cache__ = e, this.__index__ = -1, !e.length) return null;
  const t = this.re.schema_at_start.exec(e);
  if (!t) return null;
  const r = this.testSchemaAt(e, t[2], t[0].length);
  return r ? (this.__schema__ = t[2], this.__index__ = t.index + t[1].length, this.__last_index__ = t.index + t[0].length + r, Xu(this, 0)) : null;
};
L.prototype.tlds = function(e, t) {
  return e = Array.isArray(e) ? e : [e], t ? (this.__tlds__ = this.__tlds__.concat(e).sort().filter(function(r, n, c) {
    return r !== c[n - 1];
  }).reverse(), qu(this), this) : (this.__tlds__ = e.slice(), this.__tlds_replaced__ = !0, qu(this), this);
};
L.prototype.normalize = function(e) {
  e.schema || (e.url = "http://" + e.url), e.schema === "mailto:" && !/^mailto:/i.test(e.url) && (e.url = "mailto:" + e.url);
};
L.prototype.onCompile = function() {
};
const iu = 2147483647, Z = 36, c0 = 1, Du = 26, Jn = 38, Xn = 700, U0 = 72, Z0 = 128, V0 = "-", Yn = /^xn--/, Kn = /[^\0-\x7F]/, ur = /[\x2E\u3002\uFF0E\uFF61]/g, er = {
  overflow: "Overflow: input needs wider integers to process",
  "not-basic": "Illegal input >= 0x80 (not a basic code point)",
  "invalid-input": "Invalid input"
}, Gu = Z - c0, V = Math.floor, Qu = String.fromCharCode;
function Y(u) {
...
function G0(u, e) {
  const t = u.split("@");
  let r = "";
  t.length > 1 && (r = t[0] + "@", u = t[1]), u = u.replace(ur, ".");
  const n = u.split("."), c = tr(n, e).join(".");
  return r + c;
}
function Q0(u) {
  const e = [];
...
const nr = (u) => String.fromCodePoint(...u), rr = function(u) {
  return u >= 48 && u < 58 ? 26 + (u - 48) : u >= 65 && u < 91 ? u - 65 : u >= 97 && u < 123 ? u - 97 : Z;
}, w0 = function(u, e) {
  return u + 22 + 75 * (u < 26) - ((e != 0) << 5);
}, W0 = function(u, e, t) {
  let r = 0;
  for (u = t ? V(u / Xn) : u >> 1, u += V(u / e); u > Gu * Du >> 1; r += Z)
    u = V(u / Gu);
  return V(r + (Gu + 1) * u / (u + Jn));
}, J0 = function(u) {
  const e = [], t = u.length;
  let r = 0, n = Z0, c = U0, i = u.lastIndexOf(V0);
  i < 0 && (i = 0);
  for (let o = 0; o < i; ++o)
    u.charCodeAt(o) >= 128 && Y("not-basic"), e.push(u.charCodeAt(o));
  for (let o = i > 0 ? i + 1 : 0; o < t; ) {
    const a = r;
    for (let f = 1, d = Z; ; d += Z) {
      o >= t && Y("invalid-input");
      const b = rr(u.charCodeAt(o++));
      b >= Z && Y("invalid-input"), b > V((iu - r) / f) && Y("overflow"), r += b * f;
      const h = d <= c ? c0 : d >= c + Du ? Du : d - c;
      if (b < h)
        break;
      const l = Z - h;
      f > V(iu / l) && Y("overflow"), f *= l;
    }
    const s = e.length + 1;
    c = W0(r - a, s, a == 0), V(r / s) > iu - n && Y("overflow"), n += V(r / s), r %= s, e.splice(r++, 0, n);
  }
  ...
  for (i && e.push(V0); o < t; ) {
    ...
    for (const f of u)
      f >= r && f < a && (a = f);
    const s = o + 1;
    a - r > V((iu - n) / s) && Y("overflow"), n += (a - r) * s, r = a;
    for (const f of u)
      if (f < r && ++n > iu && Y("overflow"), f === r) {
        let d = n;
        for (let b = Z; ; b += Z) {
          const h = b <= c ? c0 : b >= c + Du ? Du : b - c;
          if (d < h)
            break;
          const l = d - h, g = Z - h;
          e.push(
        ...
        e.push(Qu(w0(d, 0))), c = W0(n, s, o === i), n = 0, ++o;
      }
    ++n, ++r;
  }
  return e.join("");
  ...
  return G0(u, function(e) {
    return Yn.test(e) ? J0(e.slice(4).toLowerCase()) : e;
  });
}, or = function(u) {
  return G0(u, function(e) {
    return Kn.test(e) ? "xn--" + X0(e) : e;
  });
}, Y0 = {
  /**
...
const K0 = ["http:", "https:", "mailto:"];
function br(u) {
  const e = Ku(u, !0);
  if (e.hostname && (!e.protocol || K0.indexOf(e.protocol) >= 0))
    try {
...
function pr(u) {
  ...
  return au(Yu(e), au.defaultChars + "%");
}
function $(u, e) {
  if (!(this instanceof $))
    return new $(u, e);
  e || e0(u) || (e = u || {}, u = "default"), this.inline = new Au(), this.block = new Iu(), this.core = new n0(), this.renderer = new lu(), this.linkify = new L(), this.validateLink = hr, this.normalizeLink = br, this.normalizeLinkText = pr, this.utils = xt, this.helpers = Bu({}, gt), this.options = {}, this.configure(u), e && this.set(e);
}
$.prototype.set = function(u) {
  return Bu(this.options, u), this;
};
...
const xr = (u, e) => {
  ...
  emits: ["message-sent", "message-received", "error"],
  setup(u, { emit: e }) {
    const t = u, r = e, n = he(), c = Ou(() => n?.dark?.isActive ?? !1), i = O(""), o = O(!1), a = O(null), s = O(null), f = O(null), d = O(""), b = O(!1), h = O([]), l = O([]), g = O(null), D = Ou(() => {
      const y = l.value.find((m) => m.id === g.value);
      return y ? y.title : "New Conversation";
    }), C = re({
      x: 0,
      y: 0,
      w: t.initialWidth,
      ...
      position: "absolute",
      zIndex: 1e3
    })), k = new $({ html: !0, linkify: !0 });
    k.renderer.rules.fence = (y, m, q, F, W) => {
      const N = y[m], J = N.content.trim();
      return `<div class="code-wrapper"><div class="code-header"><span>${N.info || "code"}</span><button class="copy-btn" data-code="${encodeURIComponent(
        J
      )}">COPY</button></div>${k.renderer.rules.fence.default(
        y,
        m,
        q,
        F,
    ...
    const E = (y) => k.render(y || "");
    ce(() => {
      const y = `history_${t.botName.replace(/\s/g, "_")}`, m = localStorage.getItem(y);
      m ? (l.value = JSON.parse(m), l.value.length > 0 ? P(l.value[0]) : I()) : I();
    });
    const S = () => {
      const y = `history_${t.botName.replace(/\s/g, "_")}`;
      localStorage.setItem(y, JSON.stringify(l.value));
    }, I = () => {
      const m = {
        id: Date.now(),
        ...
        messages: [
          {
            ...
            displayContent: t.systemPrompt
          },
          {
            role: "assistant",
            content: `Hello! I am ${t.botName}.`,
            displayContent: `Hello! I am ${t.botName}.`
          }
        ]
      };
      l.value.unshift(m), P(m);
    }, P = (y) => {
      g.value = y.id, h.value = y.messages.map((m) => ({
        ...m,
      ...
      l.value = l.value.filter((m) => m.id !== y), S(), g.value === y && I();
    }, fu = (y) => {
      if (y.target.closest("button")) return;
      p.value = !0;
      const m = y.clientX - C.x, q = y.clientY - C.y, F = (N) => {
        C.x = N.clientX - m, C.y = N.clientY - q;
      }, W = () => {
        p.value = !1, document.removeEventListener("mousemove", F);
      };
      document.addEventListener("mousemove", F), document.addEventListener("mouseup", W);
    }, Ru = (y) => {
      x.value = !0;
      const m = C.w, q = C.h, F = y.clientX, W = y.clientY, N = (U) => {
        C.w = Math.max(400, m + (U.clientX - F)), C.h = Math.max(400, q + (U.clientY - W));
      }, J = () => {
        x.value = !1, document.removeEventListener("mousemove", N);
      };
      document.addEventListener("mousemove", N), document.addEventListener("mouseup", J);
    }, du = () => $u(() => s.value?.focus()), hu = () => f.value?.abort(), X = (y) => {
      y.target.classList.contains("copy-btn") && be(decodeURIComponent(y.target.dataset.code)).then(() => {
        n.notify({
          message: "Copied!",
          color: "positive",
          position: "top",
      ...
      const m = a.value;
      if (!m) return;
      const q = m.getScrollTarget(), F = q.scrollHeight - q.offsetHeight - m.getScrollPosition().top < 150;
      (y || F) && $u(() => m.setScrollPosition("vertical", q.scrollHeight, 0));
    }, o0 = async () => {
      if (!i.value.trim() || o.value) return;
      const y = i.value;
      r("message-sent", y), h.value.push({ role: "user", content: y, displayContent: y }), i.value = "";
      const m = h.value.length;
      h.value.push({ role: "assistant", content: "", displayContent: "" }), o.value = !0, d.value = "", f.value = new AbortController(), nu(!0);
      const q = l.value.find(
        (F) => F.id === g.value
      );
      q && q.title === "New Conversation" && (q.title = y.substring(0, 30) + (y.length > 30 ? "..." : ""));
      try {
        const W = (await fetch(t.apiUrl, {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          signal: f.value.signal,
          body: JSON.stringify({
            model: t.model,
            messages: h.value.slice(0, -1).map((U) => ({ role: U.role, content: U.content })),
            stream: !0,
            options: {
        ...
        })).body.getReader(), N = new TextDecoder();
        let J;
        for (; ; ) {
          const { done: U, value: Lu } = await W.read();
          if (U) break;
          const Pu = N.decode(Lu).split(`
`);
          for (const bu of Pu) {
            if (!bu.trim()) continue;
            const pu = JSON.parse(bu);
            pu.message?.content && (h.value[m].content += pu.message.content, d.value = h.value[m].content, cancelAnimationFrame(J), J = requestAnimationFrame(() => {
              h.value[m].displayContent = h.value[m].content, nu();
            }));
          }
        }
        r("message-received", h.value[m].content);
      } catch (F) {
        F.name === "AbortError" ? h.value[m].content += `

**[Stopped]**` : (h.value[m].content = "⚠️ Connection Error.", r("error", F)), h.value[m].displayContent = h.value[m].content;
      } finally {
        o.value = !1, f.value = null, q && (q.messages = h.value.map((F) => ({
          role: F.role,
          content: F.content
        })), S()), nu(!0), du();
      }
    ...
    return (y, m) => {
      const q = M("q-tooltip"), F = M("q-btn"), W = M("q-toolbar-title"), N = M("q-toolbar"), J = M("q-item-label"), U = M("q-item-section"), Lu = M("q-item"), Pu = M("q-list"), bu = M("q-icon"), pu = M("q-avatar"), i0 = M("q-chat-message"), ue = M("q-spinner-dots"), ee = M("q-scroll-area"), te = M("q-input"), ne = oe("ripple");
      return j(), xu("div", {
        ref: "windowRef",
        class: ru(["ollama-chat-package shadow-10 rounded-borders overflow-hidden flex flex-column", c.value ? "bg-dark border-grey-9" : "bg-white"]),
        style: ie(_.value)
      }, [
        v(N, {
          onMousedown: fu,
          class: ru(["cursor-move noselect", c.value ? "bg-black text-white" : "bg-primary text-white"])
        }, {
          default: w(() => [
            v(F, {
              flat: "",
              ...
              dense: "",
              icon: "history",
              onClick: m[0] || (m[0] = (T) => b.value = !b.value),
              size: "sm",
              class: "q-mr-sm"
            }, {
              default: w(() => [
            ...
            v(W, { class: "text-weight-bold text-subtitle2" }, {
              default: w(() => [
                mu(a0(D.value === "New Conversation" ? u.botName : D.value), 1)
              ]),
              _: 1
            }),
            v(F, {
            ...
            v(F, {
              ...
              round: "",
              dense: "",
              icon: c.value ? "light_mode" : "dark_mode",
              onClick: m[1] || (m[1] = (T) => ae(n).dark.toggle()),
              size: "sm",
              class: "q-ml-xs"
            }, null, 8, ["icon"])
          ]),
        ...
        _u("div", _r, [
          v(se, { name: "slide" }, {
            default: w(() => [
              b.value ? (j(), xu("div", {
                key: 0,
                class: ru(["history-sidebar border-right", c.value ? "bg-grey-9" : "bg-grey-2"])
              }, [
                v(Pu, {
                  dense: "",
                  padding: ""
                  ...
                  default: w(() => [
                    ...
                    (j(!0), xu(s0, null, l0(l.value, (T) => le((j(), cu(Lu, {
                      key: T.id,
                      clickable: "",
                      active: g.value === T.id,
                      onClick: (Nu) => P(T),
          ...
          _u("div", mr, [
            v(ee, {
              class: "chat-area q-pa-md col",
              ref_key: "chatScroll",
              ref: a
            }, {
              default: w(() => [
                (j(!0), xu(s0, null, l0(h.value, (T, Nu) => (j(), xu("div", {
                  key: Nu,
                  class: "q-mb-md"
                }, [
                  T.role !== "system" ? (j(), cu(i0, {
                    key: 0,
                    name: T.role === "user" ? "Me" : u.botName,
                    sent: T.role === "user",
                    "bg-color": T.role === "user" ? "blue-7" : c.value ? "grey-9" : "grey-3",
                    "text-color": T.role === "user" || c.value ? "white" : "black"
                  }, {
                    avatar: w(() => [
                      v(pu, {
                        size: "32px",
                        class: ru(T.role === "user" ? "q-ml-sm" : "q-mr-sm")
                      }, {
                        default: w(() => [
                          v(bu, {
                            name: T.role === "user" ? "person" : "smart_toy",
                            color: T.role === "user" ? "blue-7" : "grey-6"
                          }, null, 8, ["name", "color"])
                        ]),
                        _: 2
                      }, 1032, ["class"])
                    ...
                    default: w(() => [
                      _u("div", {
                        class: ru(["markdown-body-wrapper", { "dark-mode": c.value }]),
                        innerHTML: E(T.displayContent),
                        onClick: X
                      }, null, 10, kr)
                    ]),
                    _: 2
                  }, 1032, ["name", "sent", "bg-color", "text-color"])) : Fu("", !0)
                ]))), 128)),
                o.value && d.value === "" ? (j(), cu(i0, {
                  key: 0,
                  name: u.botName,
                  "bg-color": c.value ? "grey-9" : "grey-3"
                }, {
                  avatar: w(() => [
                    v(pu, {
                      size: "32px",
                  ...
                  _: 1
                }, 8, ["name", "bg-color"])) : Fu("", !0)
              ]),
              _: 1
            }, 512),
            _u("div", {
              class: ru(["q-pa-sm border-top", c.value ? "bg-black" : "bg-white"])
            }, [
              v(te, {
                ref_key: "chatInput",
                ref: s,
                modelValue: i.value,
                "onUpdate:modelValue": m[2] || (m[2] = (T) => i.value = T),
                onKeyup: de(o0, ["enter"]),
                ...
                _: 1
              }, 8, ["modelValue", "placeholder", "dark", "disable"])
            ], 2)
          ])
        ]),
        _u("div", {
...
}, Cr = /* @__PURE__ */ xr(gr, [["__scopeId", "data-v-e2296da4"]]), Dr = (u) => {
  Object.entries({
    QBtn: we,
    QInput: ve,
    QToolbar: Fe,
    ...
    u.component(t, r);
  }), u.directive("ripple", Se), u.component("VueAiChatbot", Cr);
}, Ar = { install: Dr };
export {
  Cr as VueAiChatbot,
  Ar as default
